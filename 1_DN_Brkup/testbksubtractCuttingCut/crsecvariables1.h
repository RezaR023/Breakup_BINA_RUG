...
#define psfile0 "/home/reza/BINAreall/rootfiles/1_DN_Brkup/step2/config0.ps"
...
#define chargeadr "/home/reza/BINAreall/rootfiles/1_DN_Brkup/testbksubtractCuttingCut/chargef160.dat"
...
TH1D *Phi31pmn[Nkinema][Snr];
TH1D *Phiraw31pmn[Nkinema][Snr];
TH1D *Phi27pmn[Nkinema][Snr];
TH1D *Phiraw27pmn[Nkinema][Snr];
TH1D *Phi13pmn[Nkinema][Snr];
TH1D *Phiraw13pmn[Nkinema][Snr];
