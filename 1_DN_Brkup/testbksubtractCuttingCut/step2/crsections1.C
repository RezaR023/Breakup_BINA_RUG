...
TFile *f1=new TFile("../vbrkupAnaPowfiWholeHistNeutron_Snr12_Nbin18_newcut1_testBkSubtCutingCutn_inclRawCorr.root");
...
//double charge=1640492.0;
 ...
 double iT11[Nkinema][Snr]={0.},EiT11[Nkinema][Snr]={0.},ImiT11[Nkinema][Snr]={0.},EImiT11[Nkinema][Snr]={0.},T20[Nkinema][Snr]={0.},ET20[Nkinema][Snr]={0.},T22[Nkinema][Snr]={0.},ET22[Nkinema][Snr]={0.},ImT22[Nkinema][Snr]={0.},EImT22[Nkinema][Snr]={0.};
  ...
  TFile *f = new TFile("vNeutbrkupAnaPowfiWholeFixParNbin18Snr12_testBkSubtCutingCutn_inclRawCorr_withoffset.root","recreate");
  fitfunctions();
...
int openfiles()
{
  ...
  for(int k=0 ; k<Nkinema ; k++)
    ...
    do { l++;
      ...
      if (ES2[k][l]>70 && ES2[k][l]<71 && ES1[k][l]>20.8/* && ES1[k][l]<21*/) Smin2[k]=Scu[k][l];
      Smin1[k]=160;//140;//130;
