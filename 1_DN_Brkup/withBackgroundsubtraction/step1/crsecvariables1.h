...
#define psfile0 "/home/reza/BINAreall/rootfiles/1_DN_Brkup/withBackgroundsubtraction/step2/config0.ps"
#define Smklist "/home/reza/BINAreall/rootfiles/Datfiles/SmakingAddress2"
//#define Smklist "/home/reza/BINAreall/rootfiles/Datfiles/SmakingAddressWhole"
#define chargeadr "/home/reza/BINAreall/rootfiles/1_DN_Brkup/withBackgroundsubtraction/step2/chargef160fake.dat"
...
#define Nkinema (1)//192//64
#define Snr     (7)//(15)//(10)//11
#define Nbin   (9)
...
char canv1[Nkinema][10][350],name20[Nkinema][350],name21[Nkinema][350],name22[Nkinema][350],name22n[Nkinema][350],name23[Nkinema][350],name24[Nkinema][350],namegr[Nkinema][350],namegr1[Nkinema][350],namegr2[Nkinema][350],namegr3[Nkinema][350],namegr4[Nkinema][350],namegr5[Nkinema][350],nameNe[Nkinema][350],name230[Nkinema][350];
...
TH2D *he[Nkinema];
TH2D *he1[Nkinema];
TH1D *MissingMassN[Nkinema];

TH1D *ETrawpm31[Nkinema][Snr][Nbin];
TH1D *ETpm31[Nkinema][Snr][Nbin];
TH1D *ETrawpm27[Nkinema][Snr][Nbin];
TH1D *ETpm27[Nkinema][Snr][Nbin];
TH1D *ETrawpm13[Nkinema][Snr][Nbin];
TH1D *ETpm13[Nkinema][Snr][Nbin];


TH2D *ETp[Nkinema][Snr][Nbin];
TH2D *ETrawm[Nkinema][Snr][Nbin];
TH2D *ETm[Nkinema][Snr][Nbin];
Bool_t flag= false;
...
int Define_GCuts();
//double PID_func();
double tta_1[9]={20.,20.,20.,20.,28.,30.,33.,35.,37.};
double tta_2[9]={25.,25.,25.,25.,28.,30.,33.,35.,37.};
double phi12[9]={140.,180.,160.,140.,180.,180.,180.,180.,180.};
/***+++
