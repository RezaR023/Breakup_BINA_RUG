...
/*      TGraphErrors *gren = new TGraphErrors(10);
   ...
   gre->SetPoint(1,145,19.79458);
   gre->SetPointError(1,0,0.5387162);
   gre->SetPoint(2,155,19.2046);
   gre->SetPointError(2,0,0.5506048);
   gre->SetPoint(3,165,22.96616);
   gre->SetPointError(3,0,0.5968545);
   gre->SetPoint(4,175,36.54443);
   gre->SetPointError(4,0,0.7082054);
   gre->SetPoint(5,185,63.3609);
   gre->SetPointError(5,0,0.9196196);
   gre->SetPoint(6,195,121.8501);
   gre->SetPointError(6,0,1.261688);
   gre->SetPoint(7,205,238.8517);
   gre->SetPointError(7,0,1.758914);
   gre->SetPoint(8,215,427.5352);
   gre->SetPointError(8,0,2.344094);
   gre->SetPoint(9,225,611.4104);
   gre->SetPointError(9,0,2.809149);
   gre->Draw("sp");
   TGraphErrors *gre = new TGraphErrors(15);
   gre->SetName("gr_crsection_25_28_180");
   gre->SetTitle("");
   ...
   gre->SetPoint(1,145,23.49167);
   gre->SetPointError(1,0,0.602126);
   gre->SetPoint(2,155,24.86839);
   gre->SetPointError(2,0,0.633548);
   gre->SetPoint(3,165,32.73179);
   gre->SetPointError(3,0,0.6951594);
   gre->SetPoint(4,175,55.92231);
   gre->SetPointError(4,0,0.8704161);
   gre->SetPoint(5,185,107.623);
   gre->SetPointError(5,0,1.193076);
   gre->SetPoint(6,195,218.3219);
   gre->SetPointError(6,0,1.687904);
   gre->SetPoint(7,205,399.4502);
   gre->SetPointError(7,0,2.271135);
   gre->SetPoint(8,215,563.4);
   gre->SetPointError(8,0,2.68832);
   gre->SetPoint(9,225,483.5428);
   gre->SetPointError(9,0,2.502807);
   gre->Draw("sp");
...
// ------------>Primitives in pad: pad1_2
  ...
  /*    TGraphErrors *gren = new TGraphErrors(10);
   ...
   gre->SetMarkerColor(2);
   gre->SetMarkerStyle(26);
   gre->SetPoint(1,145,33.46884);
   gre->SetPointError(1,0,0.6861933);
   gre->SetPoint(2,155,37.98291);
   gre->SetPointError(2,0,0.7559156);
//   gre->SetPoint(3,165,-0.1177629);
//   gre->SetPointError(3,0,-0.002479758);
   gre->SetPoint(4,175,43.79432);
   gre->SetPointError(4,0,0.7965593);
   gre->SetPoint(5,185,54.34128);
   gre->SetPointError(5,0,0.8687457);
   gre->SetPoint(6,195,79.38939);
   gre->SetPointError(6,0,1.032743);
   gre->SetPoint(7,205,114.9654);
   gre->SetPointError(7,0,1.227414);
   gre->SetPoint(8,215,155.72);
   gre->SetPointError(8,0,1.425114);
   gre->SetPoint(9,225,181.7959);
   gre->SetPointError(9,0,1.546054);
//   gre->SetPoint(10,235,166.2936);
//   gre->SetPointError(10,0,1.523092);
   gre->Draw("sp");
...
/*   TGraphErrors *gren = new TGraphErrors(10);
   ...
   gre->SetMarkerColor(5);
   gre->SetMarkerStyle(20);
   gre->SetPoint(0,146.028,42.99844);
   gre->SetPointError(0,0,1.651178);
   gre->SetPoint(1,155.624,34.29294);
   gre->SetPointError(1,0,1.755777);
   gre->SetPoint(2,165.22,33.15936);
   gre->SetPointError(2,0,1.685781);
   gre->SetPoint(3,174.816,35.08406);
   gre->SetPointError(3,0,1.632994);
   gre->SetPoint(4,184.412,26.20148);
   gre->SetPointError(4,0,1.478428);
   gre->SetPoint(5,194.008,26.1079);
   gre->SetPointError(5,0,1.429026);
   gre->SetPoint(6,203.604,31.6534);
   gre->SetPointError(6,0,1.422072);
   gre->SetPoint(7,213.2,30.83007);
   gre->SetPointError(7,0,1.434051);
   gre->SetPoint(8,222.796,24.42593);
   gre->SetPointError(8,0,1.491631);
   gre->SetPoint(9,232.392,36.03069);
   gre->SetPointError(9,0,1.580117);
   gre->Draw("sp");*/
   TGraphErrors *gre = new TGraphErrors(15);
   gre->SetName("gr_crsection_25_28_140");
   gre->SetTitle("");
   ...
   gre->SetMarkerColor(2);
   gre->SetMarkerStyle(26);
   gre->SetPoint(2,155,29.9917);
   gre->SetPointError(2,0,0.7039292);
   gre->SetPoint(3,165,25.32698);
   gre->SetPointError(3,0,0.6948061);
   gre->SetPoint(4,175,25.57284);
   gre->SetPointError(4,0,0.694622);
   gre->SetPoint(5,185,21.69738);
   gre->SetPointError(5,0,0.6471483);
   gre->SetPoint(6,195,24.71852);
   gre->SetPointError(6,0,0.6389676);
   gre->SetPoint(7,205,26.36665);
   gre->SetPointError(7,0,0.6360374);
   gre->SetPoint(8,215,30.09849);
   gre->SetPointError(8,0,0.6654895);
   gre->SetPoint(9,225,35.90421);
   gre->SetPointError(9,0,0.7639737);
