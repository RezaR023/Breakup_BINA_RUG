...
// ------------>Primitives in pad: pad1_1
   ...
   gre->SetPoint(2,155,12.26696);
   gre->SetPointError(2,0,0.6112075);
   gre->SetPoint(3,165,14.31238);
   gre->SetPointError(3,0,0.6535683);
   gre->SetPoint(4,175,17.32466);
   gre->SetPointError(4,0,0.7233236);
   gre->SetPoint(5,185,22.30917);
   gre->SetPointError(5,0,0.7921312);
   gre->SetPoint(6,195,34.64531);
   gre->SetPointError(6,0,0.9256298);
   gre->SetPoint(7,205,56.7554);
   gre->SetPointError(7,0,1.131868);
   gre->SetPoint(8,215,89.94456);
   gre->SetPointError(8,0,1.404571);
   gre->SetPoint(9,225,162.8195);
   gre->SetPointError(9,0,1.915527);
   gre->SetPoint(10,235,457.0289);
   gre->SetPointError(10,0,3.23313);
   gre->Draw("sp");
   TGraphErrors *gre = new TGraphErrors(15);
   gre->SetName("gr_crsection_28_15_180");
   gre->SetTitle("");
   ...
   gre->SetPoint(2,155,13.97974);
   gre->SetPointError(2,0,0.6757388);
   gre->SetPoint(3,165,17.52992);
   gre->SetPointError(3,0,0.7617174);
   gre->SetPoint(4,175,20.3198);
   gre->SetPointError(4,0,0.8169832);
   gre->SetPoint(5,185,31.72128);
   gre->SetPointError(5,0,0.9302216);
   gre->SetPoint(6,195,54.96338);
   gre->SetPointError(6,0,1.1553);
   gre->SetPoint(7,205,84.12486);
   gre->SetPointError(7,0,1.354354);
   gre->SetPoint(8,215,122.6365);
   gre->SetPointError(8,0,1.65234);
   gre->SetPoint(9,225,197.6922);
   gre->SetPointError(9,0,2.169658);
   gre->SetPoint(10,235,328.9871);
   gre->SetPointError(10,0,2.881743);
   gre->Draw("sp");
...
// ------------>Primitives in pad: pad1_2
   ...
   gre->SetMarkerColor(2);
   gre->SetMarkerStyle(26);
   gre->SetPoint(2,155,19.74473);
   gre->SetPointError(2,0,0.7843425);
   gre->SetPoint(3,165,24.15494);
   gre->SetPointError(3,0,0.8639528);
   gre->SetPoint(4,175,28.63542);
   gre->SetPointError(4,0,0.9213672);
   gre->SetPoint(5,185,35.32705);
   gre->SetPointError(5,0,1.001449);
   gre->SetPoint(6,195,50.39117);
   gre->SetPointError(6,0,1.122254);
   gre->SetPoint(7,205,77.98637);
   gre->SetPointError(7,0,1.325459);
   gre->SetPoint(8,215,106.038);
   gre->SetPointError(8,0,1.543033);
   gre->SetPoint(9,225,167.808);
   gre->SetPointError(9,0,1.997628);
   gre->SetPoint(10,235,361.9878);
   gre->SetPointError(10,0,2.982508);
   gre->Draw("sp");
...
// ------------>Primitives in pad: pad1_3
   ...
   gre->SetMarkerColor(2);
   gre->SetMarkerStyle(26);
   gre->SetPoint(2,155,19.77242);
   gre->SetPointError(2,0,0.7937605);
   gre->SetPoint(3,165,21.42017);
   gre->SetPointError(3,0,0.8478109);
   gre->SetPoint(4,175,24.40386);
   gre->SetPointError(4,0,0.913763);
   gre->SetPoint(5,185,28.4421);
   gre->SetPointError(5,0,0.944372);
   gre->SetPoint(6,195,29.88401);
   gre->SetPointError(6,0,0.9421723);
   gre->SetPoint(7,205,37.32986);
   gre->SetPointError(7,0,0.9795928);
//   gre->SetPoint(8,215,75.66966);
//   gre->SetPointError(8,0,3.11753);
   gre->SetPoint(9,225,42.41745);
   gre->SetPointError(9,0,1.240404);
   gre->Draw("sp");
