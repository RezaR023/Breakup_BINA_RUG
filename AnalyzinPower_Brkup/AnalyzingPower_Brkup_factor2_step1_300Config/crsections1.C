...
//double charge=1640492.0;
 ...
 double iT11[Nkinema][Snr]={0.},EiT11[Nkinema][Snr]={0.},ImiT11[Nkinema][Snr]={0.},EImiT11[Nkinema][Snr]={0.},T20[Nkinema][Snr]={0.},ET20[Nkinema][Snr]={0.},T22[Nkinema][Snr]={0.},ET22[Nkinema][Snr]={0.},ImT22[Nkinema][Snr]={0.},EImT22[Nkinema][Snr]={0.};
  ...
  TFile *f = new TFile("vbrkupAnaPowfiWholeUsingCutNbin20_MyCal_100n.root","recreate");
  fitfunctions();
	...
	for(int q=0 ; q<Nkinema; q++)
	  {
		...
		if (1==1 && abs(b3_MWPCtheta1-tta1)<dtta && abs(b3_MWPCtheta2-tta2)<dtta && (abs(Delphi-pphi12)<5 || abs(Delphi+pphi12)<5))
		  {
		    ...
		    /******************/
		    if (b3_EFW1<3) Ddetec0 = b3_EFW1/d_scalning(3,b3_WLdet1,tta1);
		    if (b3_EFW1>=3 && b3_EFW1<=90) Ddetec0 = b3_EFW1/d_scalning(b3_EFW1,b3_WLdet1,tta1);//3< <90//for newst 3< <90
		    if (b3_EFW1>90) Ddetec0 = b3_EFW1/d_scalning(90,b3_WLdet1,tta1);
		    if (b3_EFW2<10) Pdetec0 = b3_EFW2/p_scalning(10,b3_WLdet1,tta2);
		    if (b3_EFW2>=10 && b3_EFW2<=105) Pdetec0 = b3_EFW2/p_scalning(b3_EFW2,b3_WLdet1,tta2);//10 < <105//for newst 20< <105
		    if (b3_EFW2>105) Pdetec0 = b3_EFW2/p_scalning(105,b3_WLdet1,tta2);
		    /**************/
		    /***************
		...
		if (1==1 && abs(b3_MWPCtheta1-tta2)<dtta && abs(b3_MWPCtheta2-tta1)<dtta && (abs(Delphi-pphi12)<5 || abs(Delphi+pphi12)<5))
		  {
		    /****************/
		    if (b3_EFW2<3) Ddetec0n = b3_EFW2/d_scalning(3,b3_WLdet1,tta2);
		    if (b3_EFW2>=3 && b3_EFW2<=90) Ddetec0n = b3_EFW2/d_scalning(b3_EFW2,b3_WLdet1,tta2);//3< <90//for newst 3< <90
		    if (b3_EFW2>90) Ddetec0n = b3_EFW2/d_scalning(90,b3_WLdet1,tta2);
