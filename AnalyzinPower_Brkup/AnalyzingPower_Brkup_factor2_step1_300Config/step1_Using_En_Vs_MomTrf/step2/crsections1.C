...
TFile *f1=new TFile("../vbrkupAnaPowfiWholeUsingCutNbin20_MixCal_100n_missMass.root");
...
//double charge=1640492.0;
 ...
 double iT11n[20][4]={0.},EiT11n[20][4]={0.},T20n[20][4]={0.},T20nn[20][4]={0.},ET20n[20][4]={0.},T22n[20][4]={0.},ET22n[20][4]={0.};
  ...
  TFile *f = new TFile("vbrkupAnaPowfiWholeFixPar3_MixCal_100n_QFSdata.root","recreate");
  fitfunctions();
	...
	{ qj=0;
	  ...
	  if ((Smin1[q]+(dss[q]/2)+(j*dss[q]))>Smin2[q] && (Smin1[q]+(dss[q]/2)+(j*dss[q]))<Smax2[q]) 
	      ...
	      if (Mtrf_p[q][j]->GetMean()>0 && (iT11[q][j]>0 ||  T20[q][j]>0 || T22[q][j]>0))
		{
	      ...
	      if (hEn[q][j]->GetMean()<.45 /*&& MinEnval[q]<0.15*/ && MinEnSval[q]>0 && MinEnSval[q]>(Smin1[q]+(j*dss[q])) && MinEnSval[q]<(Smin1[q]+((j+1)*dss[q])))
		{
