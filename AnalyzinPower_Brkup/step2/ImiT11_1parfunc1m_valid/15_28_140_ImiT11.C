...
//=========  (Fri May  4 15:35:48 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",587,71,834,578);
   Canvas_1->Range(155,-0.1543101,275,0.09188429);
   ...
   gre->SetPoint(0,175,-0.04758641);
   gre->SetPointError(0,0,0.03649333);
   gre->SetPoint(1,185,-0.06823793);
   gre->SetPointError(1,0,0.03242482);
   gre->SetPoint(2,195,-0.03350083);
   gre->SetPointError(2,0,0.0286599);
   gre->SetPoint(3,205,0.02284409);
   gre->SetPointError(3,0,0.0280078);
   gre->SetPoint(4,215,-0.01883112);
   gre->SetPointError(4,0,0.02882072);
   gre->SetPoint(5,225,-0.002458708);
   gre->SetPointError(5,0,0.03168962);
   gre->SetPoint(6,235,-0.04906418);
   gre->SetPointError(6,0,0.03363558);
   gre->SetPoint(7,245,-0.03804285);
   gre->SetPointError(7,0,0.03786376);
   gre->SetPoint(8,255,-0.07624274);
   gre->SetPointError(8,0,0.03703495);
   
   TH1F *Graph_gr_ImiT11_15_28_14036 = new TH1F("Graph_gr_ImiT11_15_28_14036","",100,167,263);
   Graph_gr_ImiT11_15_28_14036->SetMinimum(-0.1296906);
   Graph_gr_ImiT11_15_28_14036->SetMaximum(0.06726485);
