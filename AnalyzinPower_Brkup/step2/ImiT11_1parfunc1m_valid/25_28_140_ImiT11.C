...
//=========  (Fri May  4 15:38:57 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",587,71,834,578);
   Canvas_1->Range(125,-0.3660672,245,0.1389198);
   ...
   gre->SetPoint(0,145,-0.1123207);
   gre->SetPointError(0,0,0.04773751);
   gre->SetPoint(1,155,-0.173546);
   gre->SetPointError(1,0,0.0386508);
   gre->SetPoint(2,165,-0.1957969);
   gre->SetPointError(2,0,0.0390019);
   gre->SetPoint(3,175,-0.1011821);
   gre->SetPointError(3,0,0.04202782);
   gre->SetPoint(4,185,-0.2311511);
   gre->SetPointError(4,0,0.05075159);
   gre->SetPoint(5,195,0.01075783);
   gre->SetPointError(5,0,0.04399745);
   gre->SetPoint(6,205,-0.03794845);
   gre->SetPointError(6,0,0.04379008);
   gre->SetPoint(7,215,-0.06338244);
   gre->SetPointError(7,0,0.03905746);
   gre->SetPoint(8,225,-0.03904649);
   gre->SetPointError(8,0,0.03384128);
   
   TH1F *Graph_gr_ImiT11_25_28_14044 = new TH1F("Graph_gr_ImiT11_25_28_14044","",100,137,233);
   Graph_gr_ImiT11_25_28_14044->SetMinimum(-0.3155685);
   Graph_gr_ImiT11_25_28_14044->SetMaximum(0.08842109);
