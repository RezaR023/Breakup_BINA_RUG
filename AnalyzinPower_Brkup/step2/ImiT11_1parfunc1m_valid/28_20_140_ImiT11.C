...
//=========  (Fri May  4 15:39:49 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",587,71,834,578);
   Canvas_1->Range(125,-0.2584209,245,0.2162832);
   ...
   gre->SetPoint(0,145,0.03703704);
   gre->SetPointError(0,0,0.05278095);
   gre->SetPoint(1,155,-0.0575362);
   gre->SetPointError(1,0,0.04270157);
   gre->SetPoint(2,165,-0.1337526);
   gre->SetPointError(2,0,0.04555089);
   gre->SetPoint(3,175,-0.09467376);
   gre->SetPointError(3,0,0.04528507);
   gre->SetPoint(4,185,-0.06500817);
   gre->SetPointError(4,0,0.04899336);
   gre->SetPoint(5,195,-0.07104194);
   gre->SetPointError(5,0,0.04769037);
   gre->SetPoint(6,205,0.01331208);
   gre->SetPointError(6,0,0.05247303);
   gre->SetPoint(7,215,0.0870593);
   gre->SetPointError(7,0,0.05010657);
   gre->SetPoint(8,225,0.006431962);
   gre->SetPointError(8,0,0.04465759);
   
   TH1F *Graph_gr_ImiT11_28_20_14046 = new TH1F("Graph_gr_ImiT11_28_20_14046","",100,137,233);
   Graph_gr_ImiT11_28_20_14046->SetMinimum(-0.2109504);
   Graph_gr_ImiT11_28_20_14046->SetMaximum(0.1688128);
