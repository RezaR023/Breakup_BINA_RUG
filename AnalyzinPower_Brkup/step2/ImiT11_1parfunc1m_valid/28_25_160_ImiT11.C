...
//=========  (Fri May  4 15:10:58 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",587,71,834,578);
   Canvas_1->Range(125,-0.1913257,245,0.1169857);
   ...
   gre->SetPoint(0,145,-0.04577806);
   gre->SetPointError(0,0,0.04111967);
   gre->SetPoint(1,155,-0.02144724);
   gre->SetPointError(1,0,0.03751059);
   gre->SetPoint(2,165,-0.100114);
   gre->SetPointError(2,0,0.03982644);
   gre->SetPoint(3,175,-0.08703824);
   gre->SetPointError(3,0,0.03831651);
   gre->SetPoint(4,185,-0.02005426);
   gre->SetPointError(4,0,0.03326875);
   gre->SetPoint(5,195,0.00843821);
   gre->SetPointError(5,0,0.03156639);
   gre->SetPoint(6,205,0.02944921);
   gre->SetPointError(6,0,0.02590989);
   gre->SetPoint(7,215,0.04537825);
   gre->SetPointError(7,0,0.02022218);
   gre->SetPoint(8,225,0.01150629);
   gre->SetPointError(8,0,0.01551124);
   
   TH1F *Graph_gr_ImiT11_28_25_16031 = new TH1F("Graph_gr_ImiT11_28_25_16031","",100,137,233);
   Graph_gr_ImiT11_28_25_16031->SetMinimum(-0.1604946);
   Graph_gr_ImiT11_28_25_16031->SetMaximum(0.08615452);
