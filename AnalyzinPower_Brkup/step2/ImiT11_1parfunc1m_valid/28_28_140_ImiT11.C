...
//=========  (Fri May  4 15:40:22 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",587,71,834,578);
   Canvas_1->Range(115,-0.3219612,235,0.08203908);
   ...
   gre->SetPoint(0,135,-0.126189);
   gre->SetPointError(0,0,0.04920719);
   gre->SetPoint(1,145,-0.2139671);
   gre->SetPointError(1,0,0.0406607);
   gre->SetPoint(2,155,-0.1135921);
   gre->SetPointError(2,0,0.03662038);
   gre->SetPoint(3,165,-0.159712);
   gre->SetPointError(3,0,0.04040396);
   gre->SetPoint(4,175,-0.1577282);
   gre->SetPointError(4,0,0.04268115);
   gre->SetPoint(5,185,-0.02583624);
   gre->SetPointError(5,0,0.04054194);
   gre->SetPoint(6,195,-0.02687298);
   gre->SetPointError(6,0,0.03870707);
   gre->SetPoint(7,205,-0.08944763);
   gre->SetPointError(7,0,0.03471851);
   gre->SetPoint(8,215,-0.1148811);
   gre->SetPointError(8,0,0.03086315);
   
   TH1F *Graph_gr_ImiT11_28_28_14048 = new TH1F("Graph_gr_ImiT11_28_28_14048","",100,127,223);
   Graph_gr_ImiT11_28_28_14048->SetMinimum(-0.2815612);
   Graph_gr_ImiT11_28_28_14048->SetMaximum(0.04163905);
