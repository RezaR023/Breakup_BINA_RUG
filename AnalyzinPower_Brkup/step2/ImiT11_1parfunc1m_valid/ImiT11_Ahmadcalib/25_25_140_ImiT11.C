...
//=========  (Sat May  5 20:52:59 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",613,71,983,578);
   Canvas_1->Range(135,-0.2241479,255,0.1089552);
   ...
   gre->SetPoint(0,155,-0.1333743);
   gre->SetPointError(0,0,0.03525644);
   gre->SetPoint(1,165,-0.05381499);
   gre->SetPointError(1,0,0.03398979);
   gre->SetPoint(2,175,-0.0808671);
   gre->SetPointError(2,0,0.03671277);
   gre->SetPoint(3,185,-0.05720503);
   gre->SetPointError(3,0,0.04017212);
   gre->SetPoint(4,195,-0.01094312);
   gre->SetPointError(4,0,0.04101336);
   gre->SetPoint(5,205,0.008856443);
   gre->SetPointError(5,0,0.04458153);
   gre->SetPoint(6,215,-0.03962737);
   gre->SetPointError(6,0,0.04598663);
   gre->SetPoint(7,225,-0.07181665);
   gre->SetPointError(7,0,0.04116036);
   gre->SetPoint(8,235,-0.02432382);
   gre->SetPointError(8,0,0.03336057);
   
   TH1F *Graph_gr_ImiT11_25_25_14043 = new TH1F("Graph_gr_ImiT11_25_25_14043","",100,147,243);
   Graph_gr_ImiT11_25_25_14043->SetMinimum(-0.1908376);
   Graph_gr_ImiT11_25_25_14043->SetMaximum(0.07564485);
