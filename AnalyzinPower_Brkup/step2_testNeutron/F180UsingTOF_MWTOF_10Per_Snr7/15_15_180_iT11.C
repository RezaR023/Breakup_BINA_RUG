...
//=========  (Sun Jun  3 17:35:20 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",665,71,931,578);
   Canvas_1->Range(170,-0.1351098,290,0.3069568);
   ...
   gre->SetPoint(0,190,0.07802778);
   gre->SetPointError(0,0,0.08793131);
   gre->SetPoint(1,210,0.1279895);
   gre->SetPointError(1,0,0.1052896);
   gre->SetPoint(2,230,0.09696737);
   gre->SetPointError(2,0,0.08705875);
   gre->SetPoint(3,250,0.01050988);
   gre->SetPointError(3,0,0.07194193);
   gre->SetPoint(4,270,0.1572627);
   gre->SetPointError(4,0,0.06348364);
   
   TH1F *Graph_gr_iT11_15_15_1801 = new TH1F("Graph_gr_iT11_15_15_1801","",100,182,278);
   Graph_gr_iT11_15_15_1801->SetMinimum(-0.09090315);
   Graph_gr_iT11_15_15_1801->SetMaximum(0.2627501);
