...
//=========  (Sun Jun  3 17:36:38 2018) by ROOT version5.34/28
   TCanvas *Canvas_1 = new TCanvas("Canvas_1", "Canvas_1",665,71,931,578);
   Canvas_1->Range(170,-0.3499448,290,0.1329937);
   ...
   gre->SetPoint(0,190,-0.1643686);
   gre->SetPointError(0,0,0.0645476);
   gre->SetPoint(1,210,-0.1335183);
   gre->SetPointError(1,0,0.06945762);
   gre->SetPoint(2,230,-0.1332653);
   gre->SetPointError(2,0,0.08052881);
   gre->SetPoint(3,250,-0.02386398);
   gre->SetPointError(3,0,0.07636797);
   gre->SetPoint(4,270,-0.192818);
   gre->SetPointError(4,0,0.07663702);
   
   TH1F *Graph_gr_iT11_15_20_1804 = new TH1F("Graph_gr_iT11_15_20_1804","",100,182,278);
   Graph_gr_iT11_15_20_1804->SetMinimum(-0.3016509);
   Graph_gr_iT11_15_20_1804->SetMaximum(0.08469988);
