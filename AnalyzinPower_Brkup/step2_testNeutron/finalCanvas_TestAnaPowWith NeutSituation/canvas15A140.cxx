...
//     {
   ...
   tex->SetLineWidth(1.5);
   tex->Draw();
      tex = new TLatex(0.225,0.96,"iT_{11}, #phi_{12} = 140^{#circ}");
   tex->SetTextSize(0.0329484);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.488,0.96,"T_{20}, #phi_{12} = 140^{#circ}");
   tex->SetTextSize(0.0329484);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.75,0.96,"T_{22}, #phi_{12} = 140^{#circ}");
   tex->SetTextSize(0.0329484);
   tex->SetLineWidth(2);
   tex->Draw();
...
//   TH1 *hisCro = new TH2D("hisCro","",100,180,280,700,10,700);
   ...
   hisCro->Draw("");
     ...
     for (int j=0; j<Nkinema192; j++){l=1;
       ...
       if (tta_1A[i]==teta0 && tta_2A[i]==15. && phi12A[i]==140. && tta_1A[i]==tta_1[j] && tta_2A[i]==tta_2[j] && phi12A[i]==phi12[j])
	 {
...
// ------------>Primitives in pad: pad1_4
   ...
   for (int i=0; i<Nkinema; i++){
     for (int j=0; j<Nkinema192; j++){l=1;
       ...
       if (tta_1A[i]==teta0 && tta_2A[i]==20. && phi12A[i]==140. && tta_1A[i]==tta_1[j] && tta_2A[i]==tta_2[j] && phi12A[i]==phi12[j])
	 {
	   //gre_crsection_Un[i]->SetFillColor(16);
	   //gre_crsection_Un[i]->Draw("E3");
	   /* gre_crsection[j]->SetMarkerColor(4);
...
// ------------>Primitives in pad: pad1_7
   ...
   for (int i=0; i<Nkinema; i++){
     for (int j=0; j<Nkinema192; j++){l=1;
       ...
       if (tta_1A[i]==teta0 && tta_2A[i]==25. && phi12A[i]==140. && tta_1A[i]==tta_1[j] && tta_2A[i]==tta_2[j] && phi12A[i]==phi12[j])
	 {
	   //gre_crsection_Un[i]->SetFillColor(16);
	   //gre_crsection_Un[i]->Draw("E3");
	   /*gre_crsection[j]->SetMarkerColor(4);
...
// ------------>Primitives in pad: pad1_10
   ...
   for (int i=0; i<Nkinema; i++){
     for (int j=0; j<Nkinema192; j++){l=1;
       if (tta_1A[i]==teta0 && tta_2A[i]==28. && phi12A[i]==140. && tta_1A[i]==tta_1[j] && tta_2A[i]==tta_2[j] && phi12A[i]==phi12[j])
