...
//     {
   ...
   tex->Draw();
      ...
      tex = new TLatex(0.9566,0.74,"(#theta_{d}=28,#theta_{p}=15)");
   tex->SetTextSize(0.028484);
   tex->SetTextAngle(90);
   tex->SetLineWidth(1.5);
   tex->Draw();
      tex = new TLatex(0.9566,0.53,"(#theta_{d}=28,#theta_{p}=20)");
   tex->SetTextSize(0.028484);
   tex->SetTextAngle(90);
   tex->SetLineWidth(1.5);
   tex->Draw();
      tex = new TLatex(0.9566,0.33,"(#theta_{d}=28,#theta_{p}=25)");
   tex->SetTextSize(0.028484);
   tex->SetTextAngle(90);
   tex->SetLineWidth(1.5);
   tex->Draw();
