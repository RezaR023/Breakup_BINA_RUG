...
TRandom *xran = new TRandom();
   ...
   //////////cut for ouside of intersted S-cruve
   TCutG *cutgo = new TCutG("CUTGo",7);
   cutgo->SetVarX("b3_EFW1");
   cutgo->SetVarY("deltTOF2");
   cutgo->SetTitle("Graph");
   cutgo->SetFillColor(1);
   cutgo->SetPoint(0,117.169,16.9053);
   cutgo->SetPoint(1,117.169,-17.5788);
   cutgo->SetPoint(2,75,-17.1824);
   cutgo->SetPoint(3,75,-1.06342);
   cutgo->SetPoint(4,29.3919,8.84582);
   cutgo->SetPoint(5,88.2119,25.8897);
   cutgo->SetPoint(6,117.169,16.9053);
...
//double charge=1640492.0;
 ...
 /* TGraphErrors  *gr_Cro = new TGraphErrors();
  ...
  TFile *f = new TFile("vbrkupcrsecsfi180_testPIDwithTMinuit2_MMN_grt_939dot2_Neulmd.root","recreate");
  fitfunctions();
  ...
  Long64_t nentries = 1e7;//fChain->GetEntriesFast();
	...
	for(int q=0 ; q<Nkinema; q++)
	  {
	    ...
	    //int w=10;
	    //++tta1=28; qq=4; tta2=28; /*number of config*/ 
	    //++int DELTPHI=180;
	    //++if (tta1<=20) q=1;
	    //++else q=5;
	    if (abs(b3_MWPCtheta1-tta1)<2 && abs(b3_MWPCtheta2-tta2)<2 && (abs(Delphi-pphi12)<5 || abs(Delphi+pphi12)<5) && phi_selection(tta1,tta2,b3_MWPCphi1,b3_MWPCphi2))
	      {//asume that first particle is d and second is p//
		////////////////////////////		contrevent++;	    
		/*if(b3_WLdet1==1){b3_WLtdc1=b3_WLtdc1-5.25-.4; b3_WRtdc1=b3_WRtdc1-.25-.4;}
		  if(b3_WLdet2==1){b3_WLtdc2=b3_WLtdc2-5.25; b3_WRtdc2=b3_WRtdc2-.25;}
		  if(b3_WLdet1==2){b3_WLtdc1=b3_WLtdc1-1; b3_WRtdc1=b3_WRtdc1+2-1;}
		  if(b3_WLdet2==2){b3_WLtdc2=b3_WLtdc2; b3_WRtdc2=b3_WRtdc2+2;}
		  if(b3_WLdet1==3){b3_WLtdc1=b3_WLtdc1-.1-.5; b3_WRtdc1=b3_WRtdc1-1.4-.5;}
		  if(b3_WLdet2==3){b3_WLtdc2=b3_WLtdc2-.1; b3_WRtdc2=b3_WRtdc2-1.4;}
		  if(b3_WLdet1==4){b3_WLtdc1=b3_WLtdc1+.5-1.5; b3_WRtdc1=b3_WRtdc1-.5-1.5;}
		  if(b3_WLdet2==4){b3_WLtdc2=b3_WLtdc2+.5; b3_WRtdc2=b3_WRtdc2-.5;}
		  if(b3_WLdet1==5){b3_WLtdc1=b3_WLtdc1-1; b3_WRtdc1=b3_WRtdc1+3-1;}
		  if(b3_WLdet2==5){b3_WLtdc2=b3_WLtdc2; b3_WRtdc2=b3_WRtdc2+3;}
		  if(b3_WLdet1==6){b3_WLtdc1=b3_WLtdc1+2.5-.8+1; b3_WRtdc1=b3_WRtdc1+1.5-.8+1;}
		  if(b3_WLdet2==6){b3_WLtdc2=b3_WLtdc2+2.5; b3_WRtdc2=b3_WRtdc2+1.5;}
		  if(b3_WLdet1==7){b3_WLtdc1=b3_WLtdc1-3+.5;b3_WRtdc1=b3_WRtdc1-3+.5;}
		  if(b3_WLdet2==7){b3_WLtdc2=b3_WLtdc2-3;b3_WRtdc2=b3_WRtdc2-3;}
		  if(b3_WLdet1==8){b3_WLtdc1=b3_WLtdc1+1.75-1;b3_WRtdc1=b3_WRtdc1-.25-1;}
		  if(b3_WLdet2==8){b3_WLtdc2=b3_WLtdc2+1.75;b3_WRtdc2=b3_WRtdc2-.25;}
		  if(b3_WLdet1==9){b3_WLtdc1=b3_WLtdc1-.25; b3_WRtdc1=b3_WRtdc1-1.75;}
		  if(b3_WLdet2==9){b3_WLtdc2=b3_WLtdc2-.25; b3_WRtdc2=b3_WRtdc2-1.75;}
		  if(b3_WLdet1==10){b3_WLtdc1=b3_WLtdc1+.25-.6;b3_WRtdc1=b3_WRtdc1-1.75-.6;}
		  if(b3_WLdet2==10){b3_WLtdc2=b3_WLtdc2+.25;b3_WRtdc2=b3_WRtdc2-1.75;}*/
		
		
		///////////+++if(b3_WLdet1==6){b3_WLtdc1=b3_WLtdc1-3; b3_WRtdc1=b3_WRtdc1-3;}
		//////////+++if(b3_WLdet1==8){b3_WLtdc1=b3_WLtdc1-1;b3_WRtdc1=b3_WRtdc1-1;}
		...
		//++Pdetec0 = b3_EFW2/p_scalning(b3_EFW2,b3_WLdet1,tta2);
		  ...
		  Double_t eep0 = 5e-1*Ptarg0/1000;//GetEnergyResolutionNeutron(pProton);
		  Double_t ep0=(.130-Dtarg0/1000)/2;
		  ...
		  GetMomenta(b3_MWPCtheta2/r2d,b3_MWPCphi2/r2d,Ptarg00/1000,MP,pProton0);
		...
		double R22=R2-R21;
		//+++++++++TOF1dd=R11/(C0*TMath::Sqrt(1-TMath::Power((md/(Dtarg0+md)),2)))+R12/(C0*TMath::Sqrt(1-TMath::Power((md/(((Ddetec0+Dtarg0)/2)+md)),2)));
		//+++++++TOF2pp=R21/(C0*TMath::Sqrt(1-TMath::Power((mp/(Ptarg0+mp)),2)))+R22/(C0*TMath::Sqrt(1-TMath::Power((mp/(((Pdetec0+Ptarg0)/2)+mp)),2)));
		//cout << R11 << '\t' << R12 << '\t' << R1 << '\t' << R21 << '\t' << R22 << '\t' << R2 << endl;
		TOF1dd=R1/(C0*TMath::Sqrt(1-TMath::Power((md/(Dtarg0+md)),2)));
		TOF2pp=R2/(C0*TMath::Sqrt(1-TMath::Power((mp/(Ptarg00+mp)),2)));
		/**
		if (Dtarg0>60){		TOF1dd=R1/(C0*TMath::Sqrt(1-TMath::Power((md/(Dtarg0+md)),2)));}
		else {		TOF1dd=R1/(C0*TMath::Sqrt(1-TMath::Power((md/((Dtarg0+Ddetec0)/2+md)),2)));}

		if (Dtarg0>60){		TOF2pp=R2/(C0*TMath::Sqrt(1-TMath::Power((mp/(Ptarg0+mp)),2)));}
		else {		TOF2pp=R2/(C0*TMath::Sqrt(1-TMath::Power((mp/((Ptarg0+Pdetec0)/2+mp)),2)));}
		**/
		//++TOF1dd=2*R1/(C0*TMath::Sqrt(1-TMath::Power((md/(Dtarg0+md)),2))+C0*TMath::Sqrt(1-TMath::Power((md/(Ddetec0+md)),2)));
		//++TOF2pp=2*R2/(C0*TMath::Sqrt(1-TMath::Power((mp/(Ptarg0+mp)),2))+C0*TMath::Sqrt(1-TMath::Power((mp/(Pdetec0+mp)),2)));
		...
		/*for(int m=0 ; m<10 ;m++)
		  {
		    ...
		    if(b3_WLdet1 == m+1)
		      TDC_difbar1[i][m+1]->Fill(deltTOF2); 
		  }*/
		/*int qd=0;int qp=0;
		if (tta1==15){qd=1;}
		else if (tta1==18){qd=2;}
		else if (tta1==20){qd=3;}
		else if (tta1==25){qd=4;}
		else if (tta1==28){qd=5;}
		else if (tta1==30){qd=6;}
		else if (tta1==33){qd=7;}
		else if (tta1==35){qd=8;}
		else qd=5;
		if (tta2==15){qp=1;}
		else if (tta2==18){qp=2;}
		else if (tta2==20){qp=3;}
		else if (tta2==25){qp=4;}
		else if (tta2==28){qp=5;}
		else if (tta2==30){qp=6;}
		else if (tta2==33){qp=7;}
		else if (tta2==35){qp=8;}
		else qp=5;*/
		// dTOF=PID_func();
		///////////////////////////////////+++++++++++if (/*deltTOF2<1.4 &&*/ cutgn->IsInside(b3_EFW1,deltTOF2)){   
		  ...
		  if (q>=3){
		    ...
		    ///f31->SetNpx(he1->GetNbinsX());
		    //E1E2itarg[q][w]->Fill(Ptarg,Dtarg);
		  }

		  //////////////////////////////////////////////
		  TLorentzVector pDeuteronSmear;
		  GetMomenta(b3_MWPCtheta1/r2d,b3_MWPCphi1/r2d,Dtarg/1000,MD,pDeuteronSmear);

		  Double_t eep = 5e-1*Ptarg/1000;//GetEnergyResolutionNeutron(pProton);
		  Double_t ep=(.130-Dtarg/1000)/2;
		  bool success = GetNeutronEnergy(minimizer,
						  b3_MWPCtheta1/r2d,
						  b3_MWPCphi1/r2d,
						  Dtarg/1000,
						  b3_MWPCtheta2/r2d,
		  ...
		  double Ptargn= ep*1000;////mp*(1/(TMath::Sqrt(1-TMath::Power((R2/(C0*(TOF2pr/*-tofP0*/))),2)))-1);
  ...
  for(int q=0 ; q<Nkinema; q++)
	...
	{ 
	  ...
	  Double_t par[7]={4,0,0,0,50,(bmx-30),.5}; 
	  //double aa1[10]={10,20,25,25,25,25,25,25,20,10};
	  double aa1[15]={10,20,25,25,25,25,25,25,25,25,25,25,25,20,10};
	  ...
	  double omega1=(4.*D2R*(dlF1*D2R)*sin(tta_1[q]*D2R));/*sr*/
	  double omega2=(4.*D2R*(dlF2*D2R)*sin(tta_2[q]*D2R));/*sr*/
	  ...
	  cross[q][j]=cross[q][j]/(.84*.90*.99*.97*.99);
