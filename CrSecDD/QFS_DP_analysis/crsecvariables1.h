...
#define Smklist "/home/reza/BINAreall/rootfiles/CrSecDD/QFS_DP_analysis/Datfiles/SmakingAddress180"
...
#define Nkinema (8)//8
#define Snr     (1)//(10)//11
//#define Smin    (200)//(175)//140
//#define Smax    (170)//152
//#define Smax    (240)//(285)//240
#define D2R     (0.01745)
...
int contrll[Nkinema],contrl0[Nkinema],scalerCount=0;
int lg=0;
...
char canv1[Nkinema][10][350],name20[Nkinema][350],name21[Nkinema][350],name22[Nkinema][350],name23[Nkinema][350],name24[Nkinema][350],namegr[Nkinema][350];
char fifup[Nkinema][10][350];char fifud[Nkinema][10][350];
char name55[Nkinema][Snr][350],name25[Nkinema][Snr][350],name55tot[Nkinema][350],name25tot[Nkinema][350];
char nameE[Nkinema][Snr][350],nameEtot[Nkinema][350];
TH2D *sbin11[Nkinema][Snr];
TH1D *sbin1D[Nkinema][Snr];
TH1D *sbinraw1D[Nkinema][Snr];
TH2D *sbin11tot[Nkinema];
TH1D *sbin1Dtot[Nkinema];
TH1D *sbinraw1Dtot[Nkinema];
TH2D *E1E2ta[Nkinema];
...
double tta_1[8]={28.,29.,29.,30.,30.,28.,28.,30.};
double tta_2[8]={20.,22.,24.,26.,28.,18.,22.,28.};
double phi12[8]={180.,180.,180.,180.,180.,180.,180.,180.};
double Slimit[8]={230,220,220,220,210,230,230,210};
