...
//double charge=1640492.0;
 ...
 /* TGraphErrors  *gr_Cro = new TGraphErrors();
  ...
  TFile *f = new TFile("vbrkupcrsecsfi180histFitFuncs.root","recreate");
  fitfunctions();
	...
	for(int q=0 ; q<Nkinema; q++)
	  {
		...
		//++Pdetec0 = b3_EFW2/p_scalning(b3_EFW2,b3_WLdet1,tta2);
		  ...
		  //Ptarg0 = Pdetec0+funcA1->Eval(Pdetec0);
		  //Dtarg0 = Ddetec0+funcA2->Eval(Ddetec0);
		...
		**/
		...
		// dTOF=PID_func();
		if (/*deltTOF2<1.4 &&*/ cutg->IsInside(b3_EFW1,deltTOF2)){   
		  ...
		  //Ptarg = Pdetec+funcA1->Eval(Pdetec);
		  //Dtarg = Ddetec+funcA2->Eval(Ddetec);**/
		  if (q<3){
		  ...
		  double TOF2pr=TOF1dd+tdc1t-tdc2t-TDC_shift((int)b3_WLdet1,(int)b3_WLdet2,pphi12);
		  double tofP0=R22/C0*TMath::Sqrt(1-TMath::Power((mp/(Pdetec0+mp)),2));
		  double Ptargn=mp*(1/(TMath::Sqrt(1-TMath::Power((R21/(C0*(TOF2pr-tofP0))),2)))-1);
...
int openfiles()
{
  ...
  fitfuncp1= new TF1("fitfuncp1","pol5",10,105);
  ...
  for(int kk=1 ; kk<11 ; kk++){
    ...
    do { l1++;
      ...
      fitfuncp1->SetParameters(parr0[kk][l1],parr1[kk][l1],parr2[kk][l1],parr3[kk][l1],parr4[kk][l1],parr5[kk][l1]);
      fitfuncp1->Write();//SetName("");
    ...
    do { l1++;
      parainputd >> par0[kk][l1]>>par1[kk][l1]>>par2[kk][l1]>>par3[kk][l1]>>par4[kk][l1]>>par5[kk][l1]>>par6[kk][l1];
      // parainputp >> parr0[kk][l1]>>parr1[kk][l1]>>parr2[kk][l1]>>parr3[kk][l1]>>parr4[kk][l1]>>parr5[kk][l1]>>parr6[kk][l1];
    fitfuncd1->SetParameters(par0[kk][l1],par1[kk][l1],par2[kk][l1],par3[kk][l1],par4[kk][l1],par5[kk][l1]);
    fitfuncd1->Write();
