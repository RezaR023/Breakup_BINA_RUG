...
TGraphErrors *gainD[Nkinema][DetNum];
TGraphErrors *gainP[Nkinema][DetNum];
...
double parr0[DetNum][Nkinema],parr1[DetNum][Nkinema],parr2[DetNum][Nkinema],parr3[DetNum][Nkinema],parr4[DetNum][Nkinema],parr5[DetNum][Nkinema],parr6[DetNum][Nkinema],parr33[DetNum][Nkinema],parr00[DetNum][Nkinema];
double par0[DetNum][Nkinema],par1[DetNum][Nkinema],par2[DetNum][Nkinema],par3[DetNum][Nkinema],par4[DetNum][Nkinema],par5[DetNum][Nkinema],par6[DetNum][Nkinema],par7[DetNum][Nkinema];
