...
#define psfile0 "config25.ps"
#define psfile1 "config1.ps"
//#define psfile2 "/home/reza/BINAreall/rootfiles/psfiles/config2.ps"
//#define psfile3 "/home/reza/BINAreall/rootfiles/psfiles/config3.ps"
//#define psfile4 "/home/reza/BINAreall/rootfiles/psfiles/config4.ps"
//#define psfile5 "/home/reza/BINAreall/rootfiles/psfiles/config5.ps"
//#define psfile6 "/home/reza/BINAreall/rootfiles/psfiles/config6.ps"
//#define psfile7 "/home/reza/BINAreall/rootfiles/psfiles/config7.ps"
//#define psfile8 "/home/reza/BINAreall/rootfiles/psfiles/config8.ps"
...
#define Smklist "/home/reza/BINAreall/rootfiles/Datfiles/SmakingAddresscalib25"
#define outf1 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile1.dat"
#define outf2 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile2.dat"
#define outf3 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile3.dat"
#define outf4 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile4.dat"
#define outf5 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile5.dat"
#define outf6 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile6.dat"
#define outf7 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile7.dat"
#define outf8 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile8.dat"
#define outf9 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile9.dat"
#define outf10 "/home/reza/BINAreall/rootfiles/DDcalib25config/breakup_calibration_step2/Datf/outfile10.dat"
...
TF1 *finalfuncd1;
TF1 *finalfuncp1;
TF1 *finalfuncd[Nkinema][DetNum];
TF1 *finalfuncp[Nkinema][DetNum];
TF1 *finalfuncd2[Nkinema][DetNum];
TF1 *finalfuncp2[Nkinema][DetNum];
TGraphErrors *sc1;//=new TGraphErrors(10000);
TGraphErrors *sc2;
TGraphErrors *p1p2[Nkinema];
TGraphErrors *p1p2dep[Nkinema];
TGraphErrors *p1s[Nkinema];
TGraph *gainD[Nkinema][DetNum];
TGraph *gainP[Nkinema][DetNum];
TGraphErrors *gainD2[Nkinema][DetNum];
TGraphErrors *gainP2[Nkinema][DetNum];
TCanvas *c1[Nkinema][DetNum];
TCanvas *c2[Nkinema][DetNum];
TCanvas *c3[11];
TCanvas *cc;
double scale1,scale2,BC,bg,bm,bn,A1,A2;
double Scu[Nkinema][100000], ES2[Nkinema][100000], ES1[Nkinema][100000], ES3[Nkinema][100000];
double Scud[Nkinema][100000], ES2dep[Nkinema][100000], ES1dep[Nkinema][100000], ES3dep[Nkinema][100000],ES2depr[Nkinema][100000], ES1depr[Nkinema][100000];
...
double parr0[Nkinema][DetNum],parr1[Nkinema][DetNum],parr2[Nkinema][DetNum],parr3[Nkinema][DetNum],parr4[Nkinema][DetNum],parr5[Nkinema][DetNum],parr6[Nkinema][DetNum],parr33[Nkinema][DetNum],parr00[Nkinema][DetNum];
double par0[Nkinema][DetNum],par1[Nkinema][DetNum],par2[Nkinema][DetNum],par3[Nkinema][DetNum],par4[Nkinema][DetNum],par5[Nkinema][DetNum],par6[Nkinema][DetNum],par7[Nkinema][DetNum];
double pard0[Nkinema][DetNum],pard1[Nkinema][DetNum],pard2[Nkinema][DetNum],pard3[Nkinema][DetNum],pard4[Nkinema][DetNum],pard5[Nkinema][DetNum],pard6[Nkinema][DetNum],parp0[Nkinema][DetNum],parp1[Nkinema][DetNum],parp2[Nkinema][DetNum],parp3[Nkinema][DetNum],parp4[Nkinema][DetNum],parp5[Nkinema][DetNum],parp6[Nkinema][DetNum];
...
double Xmin[Nkinema][DetNum],Xmax[Nkinema][DetNum],Ymin[Nkinema][DetNum],Ymax[Nkinema][DetNum];
char nam1a[Nkinema][350];
char name2a[Nkinema][DetNum][350];
char namegD[Nkinema][DetNum][350],namegP[Nkinema][DetNum][350];
char namproj[Nkinema][DetNum][350];
char nam4[Nkinema][DetNum][350];
char nam5[Nkinema][DetNum][350];
char nam6[Nkinema][DetNum][350];
char nam7[Nkinema][DetNum][350];
char nam8[Nkinema][DetNum][350];
char nam9[Nkinema][DetNum][350];
char namfd[Nkinema][DetNum][350];
char namfp[Nkinema][DetNum][350];
char namn[Nkinema][DetNum][350];
char canv[Nkinema][DetNum][350];
char canv1[Nkinema][DetNum][350];
char fifup[Nkinema][DetNum][350];char fifud[Nkinema][DetNum][350];
TH2D *E1E2ta[Nkinema];
TH2D *E1E2ia[Nkinema][DetNum];
TH2D *E1E2i[Nkinema][DetNum];
TH1D *E1E2proj[Nkinema][DetNum];
TH2D *E1E2idetec[Nkinema][DetNum];
TH2D *E1E2itarg[Nkinema][DetNum];
TH2D *gaindd[Nkinema][DetNum];
TH2D *gainpp[Nkinema][DetNum];
TH2D *henergy1[Nkinema][DetNum];
...
double tta_1[25]={15.,15.,15.,15.,15.,20.,20.,20.,20.,20.,25.,25.,25.,25.,25.,30.,30.,30.,30.,30.,35.,35.,35.,35.,35.};
double tta_2[25]={15.,20.,25.,30.,35.,15.,20.,25.,30.,35.,15.,20.,25.,30.,35.,15.,20.,25.,30.,35.,15.,20.,25.,30.,35.};
double phi12[25]={180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.,180.};
