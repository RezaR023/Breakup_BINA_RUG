...
#include "Riostream.h"
#include "fstream.h"
#define ofi "/home/reza/BINAreall/rootfiles/DPbrkup/EdEpTGenelas.dat"
  ...
  TH1F *hvar = new TH1F("hvar","",6000,-2000,4000);
   for (Int_t n=0;n<1E7;n++) {
      ...
      /*  if (TMath::Abs(po1i-28)<1 && TMath::Abs(po3i-28)<1 && TMath::Abs(phi12i-180)<10)
	 {
      ...
      /////if (TMath::Abs(po1-28)<1 && TMath::Abs(po2-28)<1 &&  TMath::Abs(phi12-180)<10)
...
--*/
	     hteta1->Fill(po1,Ep1t ,weight);
	      hteta2->Fill(po2,Ep2t ,weight);
