...
#ifdef tgeant_cxx
tgeant::tgeant(TTree *tree) : fChain(0) 
{
...
Int_t tgeant::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tgeant::LoadTree(Long64_t entry)
{
...
void tgeant::Show(Long64_t entry)
{
...
Int_t tgeant::Cut(Long64_t entry)
{
