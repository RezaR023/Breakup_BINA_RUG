...
void calibcal::Loop()
{
  ...
  TFile *f = new TFile("vhistAllconfigvastf_withoutPreCal.root","recreate");
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    if(b3_MWPCphi1>0. && b3_MWPCphi2>0. && b3_MWPCphi1<360. && b3_MWPCphi2<360.)	 Delphi= abs(b3_MWPCphi1-b3_MWPCphi2);
	  ...
	  if(b3_T1>0 && (b3_WLdet1!=b3_WLdet2) && (b3_WRdet1!=b3_WRdet2) &&  b3_EFW2>0 && b3_EFW1>0 )
		...
		if (abs(b3_MWPCtheta1-tta1)<2 && abs(b3_MWPCtheta2-tta2)<2 && abs(abs(b3_MWPCphi1-b3_MWPCphi2)-pphi12)<30  && b3_WLdet1==w)
