...
#ifdef calibcal1_cxx
calibcal1::calibcal1(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      //chain->Add("/home/reza/BINAreall/rootfiles/break405_450newcalib.root/pdbreakup");
      //chain->Add("/home/reza/BINAreall/rootfiles/breakT541_570newcalib.root/pdbreakup");
...
Int_t calibcal1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t calibcal1::LoadTree(Long64_t entry)
{
...
void calibcal1::Init(TTree *tree)
{
...
void calibcal1::Show(Long64_t entry)
{
...
Int_t calibcal1::Cut(Long64_t entry)
{
