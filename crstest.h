...
// Mon Aug 28 14:44:47 2017 by ROOT version 5.34/28
...
#ifdef crstest_cxx
crstest::crstest(TTree *tree) : fChain(0) 
{
...
Int_t crstest::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t crstest::LoadTree(Long64_t entry)
{
...
void crstest::Show(Long64_t entry)
{
...
Int_t crstest::Cut(Long64_t entry)
{
